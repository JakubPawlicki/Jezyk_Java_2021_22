...
class StringValueTest {
    ...
    @Test
    void test_StringValueBuilt_Eq_StringValueCreated() {
        StringValue StringValue1 = StringValue.builder().setValue("abc").build();
        StringValue StringValue2 = (StringValue) StringValue.create("abc");
        assertEquals(true, StringValue1.eq(StringValue1));
        assertEquals(false, StringValue1.eq(StringValue2));
    }

    @Test
    void test_StringValueBuilt_Lte_StringValueCreated() {
        StringValue StringValue1 = StringValue.builder().setValue("12").build();
        StringValue StringValue2 = (StringValue) StringValue.create("123");
        assertEquals(false, StringValue2.lte(StringValue1));
        assertEquals(true, StringValue1.lte(StringValue2));
    }

    @Test
    void test_StringValueBuilt_Gte_StringValueCreated() {
        StringValue StringValue1 = StringValue.builder().setValue("1234").build();
        StringValue StringValue2 = (StringValue) StringValue.create("123");
        assertEquals(false, StringValue2.gte(StringValue1));
        assertEquals(true, StringValue1.gte(StringValue2));
    }
}
