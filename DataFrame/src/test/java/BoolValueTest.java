...
class BoolValueTest {
    ...
    @Test
    void test_BoolValueMul() {
        BoolValue boolValue1 = BoolValue.builder().setValue(true).build();
        BoolValue boolValue2 = BoolValue.builder().setValue(false).build();
        BoolValue boolValue1mul2 = (BoolValue) boolValue1.mul(boolValue2);

        BoolValue boolValue3 = BoolValue.builder().setValue(false).build();

        assertEquals(boolValue1mul2, boolValue3);
    }
